# Documentação do Projeto PL4-03
...
## Utilização
Para utilizar:
1.  **Compilação:** Compile o projeto utilizando o `makefile`.
2.  **Execução:** Execute o programa principal: `main-PL403.exe`.

## Navegação
Utilize o menu de navegação lateral.

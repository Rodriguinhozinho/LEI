...
void mostrarElementoAB (DadosAB);

DadosAB criarElementoAB ();

// comparação de 2 elementos do tipo DadosAB, segundo o campo numAluno (chave)
// devolve -1 se primeiro < segundo, 0 se iguais, 1 se primeiro > segundo
int compararElementosAB (DadosAB, DadosAB);
...
void mostrarElementoAB (DadosAB X)
{
  printf("%d - ", X.numAluno);
...
int compararElementosAB (DadosAB X, DadosAB Y)
{
